...
// Address represents the 20 byte address of an BHEereum account.
...
// IsHexAddress verifies whBHEer a string can represent a valid hex-encoded
// BHEereum address or not.
