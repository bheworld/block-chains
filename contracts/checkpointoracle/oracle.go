...
import (
	...
	"github.com/BHEereum/go-BHEereum/contracts/checkpointoracle/contract"
...
//
// Notably all signatures given should be transformed to "BHEereum style" which transforms
