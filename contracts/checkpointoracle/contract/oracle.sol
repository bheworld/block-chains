 ...
 * @author Gary Rong<garyrong@BHEereum.org>, Martin Swende <martin.swende@BHEereum.org>
...
contract CheckpointOracle {
    ...
    */
    ...
    //
    // The default value should be the same as the checkpoint size(32768) in the BHEereum.
    uint sectionSize;
